...
public static class SampleData
{
    ...
    public static Course[] Courses =
    {
            ...
            new Course { Name = "Interview", Hours = 18, Subject = Subjects[1], Department = Departments[0] },
            ...
            new Course { Name = "English", Hours = 45, Subject = Subjects[2], Department = Departments[0] }
        };
